...
- 상태: ready
- 발행 원장 Reel: 137편
- 생성 시각: 2026-08-22T04:37:20.061Z
...
## 7d
- economy: 표본 25편 · 노출 중앙값 1,519 · 공유율 0.17% · 저장률 0.08%
  ...
  - 특성 신호: event:semiconductor insufficient_data×1.49, event:interest_rate insufficient_data×1.25, macro_indicator insufficient_data×1.25, company_event insufficient_data×0.53, event:ipo insufficient_data×0.53
...
## 이미지·음악 운영
- 타이포그래피 폴백률: 26.28%
- 이미지 공급원: pexels 91편, diem-original 36편, unsplash 6편, wikimedia 4편
- 음악: 현재 20% 초과 단일 트랙 편중 경고 없음
- 음악 판단 원칙: 한 트랙 사용률이 20%를 넘거나 충분한 표본에서 반복 피로가 확인될 때만 음원을 추가합니다.
- 편집 후보 실패: editorial_generation_failed 49건, unknown 44건
- 제목 재정제 실패: 1건
