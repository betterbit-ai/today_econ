...
- issue: 표본 79편 · 노출 중앙값 402 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy winner×3.84, market_shock insufficient_data×3.68, housing_money winner×2.4, event:political_statement winner×2.3, public_decision winner×2.24, event:interest_rate insufficient_data×0.68, macro_indicator insufficient_data×0.68, reader_need:credit insufficient_data×0.68
- 정시 비교에서 제외한 늦은 백필: 90편

## 72h
- economy: 표본 74편 · 노출 중앙값 229 · 공유율 0% · 저장률 0%
  - 반복 후보: 이재명 / ISA 개편 중단(722,599), 비거주1주택 / 징벌과세 결정(148,114), 공무원 / 광고 사과(4,641), 보유세 개편 / 결정(2,297), 백악관 경고 / 중국 환적 우려(2,251)
  - 특성 신호: event:ipo insufficient_data×2.09, event:housing_policy winner×1.86, housing_money winner×1.66, public_decision winner×1.37, event:insurance_premium insufficient_data×0.78, event:political_statement insufficient_data×0.72
...
- issue: 표본 96편 · 노출 중앙값 1,073.5 · 공유율 0% · 저장률 0%
