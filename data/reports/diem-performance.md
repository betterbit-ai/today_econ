...
## 24h
- economy: 표본 49편 · 노출 중앙값 312 · 공유율 0% · 저장률 0%
...
- issue: 표본 54편 · 노출 중앙값 1,503 · 공유율 0.04% · 저장률 0%
  - 반복 후보: 주진우 증언 / 우원식표결지연(32,963), 바이든 암 / 전이 확인(21,336), 선관위 / 서울시장 소청 기각(7,810), 북 미사일 발사 / 김여정 조롱(5,393), 한동훈 흉기 / 징역 1년 확정(3,959)
  - 부진 후보: 네팔 대홍수 / 보도(81), 3인 가족 / 수수료 급등(169), 광복연휴 비예보 / 폭염 예상(176), 장동혁 발언 / 당원 주권 확대(182), 요코하마시장 사퇴 / 폭언 논란(186)
  - 특성 신호: market_shock insufficient_data×0.99, event:political_statement insufficient_data×0.62, reader_need:public_interest underperformer×0.16, household_money insufficient_data×0.15, reader_need:housing insufficient_data×0.15, work_life insufficient_data×0.12, reader_need:work insufficient_data×0.11
