...
- issue: 표본 81편 · 노출 중앙값 402 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy winner×5.28, housing_money winner×3.68, market_shock insufficient_data×3.68, event:political_statement winner×2.3, public_decision winner×2.24, event:interest_rate insufficient_data×0.68, macro_indicator insufficient_data×0.68, reader_need:credit insufficient_data×0.68
...
## 이미지·음악 운영
- 타이포그래피 폴백률: 17.07%
- 생성 배경 폴백률: 38.62% · 전체 폴백률: 55.69%
- 이미지 공급원: pexels 98편, diem-generated 95편, diem-original 42편, unsplash 6편, wikimedia 4편, openverse 1편
- 최근 7일 폴백률: 100% (12/12편, 2026-09-20~2026-09-26)
