...
- 상태: ready
- 발행 원장 Reel: 147편
- 생성 시각: 2026-08-24T04:45:24.073Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 29편 · 노출 중앙값 618 · 공유율 0% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018), 김민석 / 압승 확정(1,969)
  - 부진 후보: ETF·ETN / 핵심 차이(133), 주차 로봇 / 아파트 도입(145), 통영 폭우 / 도로·공장 붕괴(158), 서초·강남 / 2주 연속 하락(167), 중국인 추납 / 연금 논란(168)
  - 특성 신호: event:semiconductor winner×3.19, event:interest_rate insufficient_data×2.46, macro_indicator insufficient_data×2.46, housing_money winner×1.56, event:ipo insufficient_data×1.27, event:market_move insufficient_data×1, market_shock insufficient_data×1, company_event insufficient_data×0.91
- issue: 표본 32편 · 노출 중앙값 1,637.5 · 공유율 0.12% · 저장률 0%
  - 반복 후보: 주진우 증언 / 우원식표결지연(23,904), 선관위 / 서울시장 소청 기각(7,617), 북 미사일 발사 / 김여정 조롱(5,362), 한동훈 흉기 / 징역 1년 확정(3,867), 트럼프 분노 / 한국 희생양(3,691)
  - 부진 후보: 광복연휴 비예보 / 폭염 예상(173), 백화점 난동 / 5년 형 선고(189), 이란 협상파 / 전쟁 종식 촉구(421), 롤스로이스 / 주차 빌런 보도(456), 대전시 / 공공기관2차선점전(460)
  - 특성 신호: event:housing_policy insufficient_data×1.65, market_shock insufficient_data×0.9
- 정시 비교에서 제외한 늦은 백필: 82편

## 72h
- economy: 표본 25편 · 노출 중앙값 1,344 · 공유율 0.06% · 저장률 0%
  - 반복 후보: 이재명 / ISA 개편 중단(722,599), 비거주1주택 / 징벌과세 결정(148,114), 공무원 / 광고 사과(4,641), 보유세 개편 / 결정(2,297), 백악관 경고 / 중국 환적 우려(2,251)
  - 부진 후보: 주차 로봇 / 아파트 도입(152), 통영 폭우 / 도로·공장 붕괴(162), 서초·강남 / 2주 연속 하락(175), ISA 세금 / 줄이는 방식(358), 일본 기업 / 정년 65세 연장(359)
  - 특성 신호: event:semiconductor insufficient_data×1.58, event:interest_rate insufficient_data×1.14, macro_indicator insufficient_data×1.14, work_life insufficient_data×0.79, event:ipo insufficient_data×0.59, company_event insufficient_data×0.43
- issue: 표본 32편 · 노출 중앙값 1,639 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.69, public_decision winner×1.39, market_shock insufficient_data×0.91
- 정시 비교에서 제외한 늦은 백필: 70편
...
- issue: 표본 38편 · 노출 중앙값 1,638.5 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: housing_money insufficient_data×1.08, event:legislation underperformer×0.29, work_life insufficient_data×0.19
...
- 편집 후보 실패: editorial_generation_failed 62건, unknown 44건
- 제목 재정제 실패: 2건
