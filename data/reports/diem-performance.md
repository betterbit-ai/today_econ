...
- 상태: ready
- 발행 원장 Reel: 181편
- 생성 시각: 2026-09-03T14:13:28.465Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 47편 · 노출 중앙값 335 · 공유율 0% · 저장률 0%
...
- issue: 표본 45편 · 노출 중앙값 1,465 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: market_shock insufficient_data×1.01, event:political_statement insufficient_data×0.63, reader_need:public_interest underperformer×0.19, household_money insufficient_data×0.14, reader_need:housing insufficient_data×0.14, work_life insufficient_data×0.12, reader_need:work insufficient_data×0.11
- 정시 비교에서 제외한 늦은 백필: 87편

## 72h
- economy: 표본 46편 · 노출 중앙값 371 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:interest_rate insufficient_data×4.12, event:semiconductor winner×3.12, reader_need:public_interest insufficient_data×2.41, event:market_move insufficient_data×2.25, market_shock insufficient_data×2.25, event:ipo insufficient_data×2.16, housing_money winner×1.58, company_event insufficient_data×1.56
- issue: 표본 51편 · 노출 중앙값 1,540 · 공유율 0.08% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.8, market_shock insufficient_data×0.97, event:political_statement insufficient_data×0.6, reader_need:public_interest underperformer×0.19, work_life insufficient_data×0.12, reader_need:work insufficient_data×0.11
- 정시 비교에서 제외한 늦은 백필: 77편

## 7d
- economy: 표본 50편 · 노출 중앙값 797.5 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:interest_rate insufficient_data×2.38, macro_indicator insufficient_data×2.38, work_life winner×1.8, housing_money winner×1.7, public_decision winner×1.7, event:semiconductor winner×1.46, event:market_move insufficient_data×1.11, market_shock insufficient_data×1.11
- issue: 표본 58편 · 노출 중앙값 1,618.5 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: market_shock insufficient_data×0.92, event:legislation underperformer×0.29, work_life insufficient_data×0.15, reader_need:public_interest underperformer×0.14, reader_need:work insufficient_data×0.11
- 정시 비교에서 제외한 늦은 백필: 39편

## 이미지·음악 운영
- 타이포그래피 폴백률: 22.65%
- 생성 배경 폴백률: 18.23% · 전체 폴백률: 40.88%
- 이미지 공급원: pexels 96편, diem-original 41편, diem-generated 33편, unsplash 6편, wikimedia 4편, openverse 1편
- 음악: 현재 20% 초과 단일 트랙 편중 경고 없음
- 음악 판단 원칙: 한 트랙 사용률이 20%를 넘거나 충분한 표본에서 반복 피로가 확인될 때만 음원을 추가합니다.
- 편집 후보 실패: editorial_generation_failed 84건, unknown 44건
- 제목 재정제 실패: 5건
