...
- 상태: ready
- 발행 원장 Reel: 200편
- 생성 시각: 2026-09-09T08:39:21.230Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 54편 · 노출 중앙값 249.5 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: reader_need:public_interest insufficient_data×3.52, event:ipo insufficient_data×3.14, company_event insufficient_data×2.25, housing_money winner×1.93, market_shock insufficient_data×1.69, event:market_move insufficient_data×1.6, public_decision winner×1.41, event:insurance_premium insufficient_data×0.67
- issue: 표본 57편 · 노출 중앙값 1,244 · 공유율 0% · 저장률 0%
  - 반복 후보: 주진우 증언 / 우원식표결지연(23,904), 선관위 / 서울시장 소청 기각(7,617), 북 미사일 발사 / 김여정 조롱(5,362), 한동훈 흉기 / 징역 1년 확정(3,867), 트럼프 분노 / 한국 희생양(3,691)
  - 부진 후보: 네팔 대홍수 / 보도(73), 미국 대학 / 입학 러브콜(141), 3인 가족 / 수수료 급등(157), 성평등·법무부 / 세종 이전(166), 광복연휴 비예보 / 폭염 예상(173)
  - 특성 신호: market_shock insufficient_data×1.19, event:political_statement underperformer×0.48, reader_need:public_interest underperformer×0.22, household_money insufficient_data×0.16, reader_need:housing insufficient_data×0.15, work_life insufficient_data×0.14, reader_need:work insufficient_data×0.13
- 정시 비교에서 제외한 늦은 백필: 87편

## 72h
- economy: 표본 55편 · 노출 중앙값 331 · 공유율 0% · 저장률 0%
...
- issue: 표본 59편 · 노출 중앙값 1,494 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: market_shock insufficient_data×0.99, event:political_statement underperformer×0.62, reader_need:public_interest underperformer×0.2, household_money insufficient_data×0.15, reader_need:housing insufficient_data×0.13, work_life insufficient_data×0.12, reader_need:work insufficient_data×0.11
- 정시 비교에서 제외한 늦은 백필: 77편

## 7d
- economy: 표본 62편 · 노출 중앙값 539 · 공유율 0% · 저장률 0%
