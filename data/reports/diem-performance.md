...
- 상태: ready
- 발행 원장 Reel: 141편
- 생성 시각: 2026-08-22T16:24:31.393Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 23편 · 노출 중앙값 855 · 공유율 0% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018), 김민석 / 압승 확정(1,969)
  - 부진 후보: 주차 로봇 / 아파트 도입(145), 통영 폭우 / 도로·공장 붕괴(158), 서초·강남 / 2주 연속 하락(167), 중국인 추납 / 연금 논란(168), 일본 기업 / 정년 65세 연장(339)
  - 특성 신호: event:semiconductor insufficient_data×2.45, event:interest_rate insufficient_data×1.78, macro_indicator insufficient_data×1.78, housing_money winner×1.56, event:housing_policy winner×1.43, event:ipo insufficient_data×0.92, company_event insufficient_data×0.66, household_money underperformer×0.4
- issue: 표본 27편 · 노출 중앙값 1,637 · 공유율 0.15% · 저장률 0%
...
## 72h
- economy: 표본 23편 · 노출 중앙값 1,371 · 공유율 0.08% · 저장률 0%
  - 반복 후보: 이재명 / ISA 개편 중단(722,599), 비거주1주택 / 징벌과세 결정(148,114), 공무원 / 광고 사과(4,641), 보유세 개편 / 결정(2,297), 백악관 경고 / 중국 환적 우려(2,251)
  - 부진 후보: 통영 폭우 / 도로·공장 붕괴(162), ISA 세금 / 줄이는 방식(358), 일본 기업 / 정년 65세 연장(359), ISA 개편 / 복원안 발표(383), 거제 폭우 / 복구 진행(492)
  - 특성 신호: event:semiconductor insufficient_data×1.55, event:interest_rate insufficient_data×1.12, macro_indicator insufficient_data×1.12, work_life insufficient_data×0.77, household_money underperformer×0.69, event:ipo insufficient_data×0.58, company_event insufficient_data×0.42
- issue: 표본 29편 · 노출 중앙값 1,646 · 공유율 0.09% · 저장률 0%
...
- issue: 표본 34편 · 노출 중앙값 1,626 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: housing_money insufficient_data×1.09, event:legislation underperformer×0.29, work_life insufficient_data×0.19
- 정시 비교에서 제외한 늦은 백필: 31편

## 이미지·음악 운영
- 타이포그래피 폴백률: 26.24%
- 이미지 공급원: pexels 94편, diem-original 37편, unsplash 6편, wikimedia 4편
- 음악: 현재 20% 초과 단일 트랙 편중 경고 없음
- 음악 판단 원칙: 한 트랙 사용률이 20%를 넘거나 충분한 표본에서 반복 피로가 확인될 때만 음원을 추가합니다.
- 편집 후보 실패: editorial_generation_failed 50건, unknown 44건
- 제목 재정제 실패: 1건
