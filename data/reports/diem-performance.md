...
- 상태: ready
- 발행 원장 Reel: 176편
- 생성 시각: 2026-09-01T14:33:23.583Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 43편 · 노출 중앙값 339 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:interest_rate insufficient_data×4.49, event:semiconductor winner×3.29, reader_need:public_interest insufficient_data×2.59, event:ipo insufficient_data×2.31, event:market_move insufficient_data×1.82, market_shock insufficient_data×1.82, company_event insufficient_data×1.66, housing_money winner×1.63
...
## 72h
- economy: 표본 42편 · 노출 중앙값 532.5 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: reader_need:public_interest insufficient_data×3.05, event:interest_rate insufficient_data×2.87, event:semiconductor winner×2.18, event:market_move insufficient_data×1.57, market_shock insufficient_data×1.57, macro_indicator insufficient_data×1.55, event:ipo insufficient_data×1.5, company_event insufficient_data×1.09
- issue: 표본 47편 · 노출 중앙값 1,575 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.76, market_shock insufficient_data×0.94, reader_need:public_interest underperformer×0.15, work_life insufficient_data×0.11, reader_need:work insufficient_data×0.11
- 정시 비교에서 제외한 늦은 백필: 75편

## 7d
- economy: 표본 47편 · 노출 중앙값 883 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:semiconductor winner×2.26, event:interest_rate insufficient_data×2.15, macro_indicator insufficient_data×2.15, work_life winner×1.63, housing_money winner×1.58, public_decision winner×1.54, event:housing_policy winner×1.5, event:market_move insufficient_data×1
