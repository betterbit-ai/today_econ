...
- 상태: ready
- 발행 원장 Reel: 149편
- 생성 시각: 2026-08-25T10:31:32.307Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 31편 · 노출 중앙값 557 · 공유율 0% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018), 김민석 / 압승 확정(1,969)
  - 부진 후보: ETF·ETN / 핵심 차이(133), 주차 로봇 / 아파트 도입(145), 서울 아파트값 / 16억 돌파(148), 통영 폭우 / 도로·공장 붕괴(158), 에드가 휘경 / 1080억 공매(162)
  - 특성 신호: event:semiconductor winner×3.54, event:interest_rate insufficient_data×2.73, macro_indicator insufficient_data×2.73, event:ipo insufficient_data×1.41, event:market_move insufficient_data×1.11, market_shock insufficient_data×1.11, company_event insufficient_data×1.01, event:housing_policy underperformer×0.68
...
## 72h
- economy: 표본 30편 · 노출 중앙값 1,075 · 공유율 0% · 저장률 0%
  - 반복 후보: 이재명 / ISA 개편 중단(722,599), 비거주1주택 / 징벌과세 결정(148,114), 공무원 / 광고 사과(4,641), 보유세 개편 / 결정(2,297), 백악관 경고 / 중국 환적 우려(2,251)
  - 부진 후보: 주차 로봇 / 아파트 도입(152), 통영 폭우 / 도로·공장 붕괴(162), 중국인 추납 / 연금 논란(175), 서초·강남 / 2주 연속 하락(175), 6억 허들 / 정책대출 고정(209)
  - 특성 신호: event:semiconductor winner×1.85, event:interest_rate insufficient_data×1.42, macro_indicator insufficient_data×1.42, event:market_move insufficient_data×0.78, market_shock insufficient_data×0.78, event:ipo insufficient_data×0.74, company_event insufficient_data×0.54, household_money underperformer×0.33
- issue: 표본 37편 · 노출 중앙값 1,668 · 공유율 0.14% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.66, market_shock insufficient_data×0.89
...
- issue: 표본 39편 · 노출 중앙값 1,630 · 공유율 0.09% · 저장률 0%
...
## 이미지·음악 운영
- 타이포그래피 폴백률: 26.85%
- 생성 배경 폴백률: 1.34% · 전체 폴백률: 28.19%
- 이미지 공급원: pexels 96편, diem-original 40편, unsplash 6편, wikimedia 4편, diem-generated 2편, openverse 1편
- 음악: 현재 20% 초과 단일 트랙 편중 경고 없음
- 음악 판단 원칙: 한 트랙 사용률이 20%를 넘거나 충분한 표본에서 반복 피로가 확인될 때만 음원을 추가합니다.
- 편집 후보 실패: editorial_generation_failed 73건, unknown 44건
- 제목 재정제 실패: 2건
