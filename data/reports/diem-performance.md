...
- 상태: ready
- 발행 원장 Reel: 126편
- 생성 시각: 2026-08-20T10:31:12.394Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 19편 · 노출 중앙값 1,330 · 공유율 0.08% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018)
  - 부진 후보: 통영 폭우 / 도로·공장 붕괴(158), ISA 세금 / 줄이는 방식(341), ISA 개편 / 복원안 발표(365), 거제 폭우 / 복구 진행(482), 이만희 재판 / 합의부 재배당(557)
...
- issue: 표본 21편 · 노출 중앙값 1,637 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.65, housing_money insufficient_data×0.64
...
- issue: 표본 24편 · 노출 중앙값 1,657 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.67, housing_money insufficient_data×1.07
- 정시 비교에서 제외한 늦은 백필: 66편

## 7d
- economy: 표본 20편 · 노출 중앙값 1,440 · 공유율 0.17% · 저장률 0.09%
...
- issue: 표본 29편 · 노출 중앙값 1,622 · 공유율 0.09% · 저장률 0%
