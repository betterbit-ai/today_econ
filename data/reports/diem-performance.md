...
- 상태: ready
- 발행 원장 Reel: 201편
- 생성 시각: 2026-09-09T14:12:28.526Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 55편 · 노출 중앙값 263 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: reader_need:public_interest insufficient_data×3.34, event:ipo insufficient_data×2.98, company_event insufficient_data×2.13, housing_money winner×1.97, market_shock insufficient_data×1.6, event:market_move insufficient_data×1.52, event:housing_policy winner×1.48, public_decision winner×1.39
...
- issue: 표본 66편 · 노출 중앙값 1,542.5 · 공유율 0.08% · 저장률 0%
  ...
  - 특성 신호: market_shock insufficient_data×0.97, event:housing_policy underperformer×0.68, event:political_statement insufficient_data×0.6, event:legislation underperformer×0.31, reader_need:public_interest underperformer×0.19, household_money insufficient_data×0.15, reader_need:housing insufficient_data×0.15, work_life underperformer×0.12
- 정시 비교에서 제외한 늦은 백필: 40편

## 이미지·음악 운영
- 타이포그래피 폴백률: 20.9%
- 생성 배경 폴백률: 25.37% · 전체 폴백률: 46.27%
- 이미지 공급원: pexels 97편, diem-generated 51편, diem-original 42편, unsplash 6편, wikimedia 4편, openverse 1편
