...
- 상태: ready
- 발행 원장 Reel: 149편
- 생성 시각: 2026-08-25T04:40:55.062Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 30편 · 노출 중앙값 587.5 · 공유율 0% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018), 김민석 / 압승 확정(1,969)
  - 부진 후보: ETF·ETN / 핵심 차이(133), 주차 로봇 / 아파트 도입(145), 서울 아파트값 / 16억 돌파(148), 통영 폭우 / 도로·공장 붕괴(158), 서초·강남 / 2주 연속 하락(167)
  - 특성 신호: event:semiconductor winner×3.35, event:interest_rate insufficient_data×2.59, macro_indicator insufficient_data×2.59, event:ipo insufficient_data×1.33, event:market_move insufficient_data×1.05, market_shock insufficient_data×1.05, company_event insufficient_data×0.95, household_money underperformer×0.58
...
## 72h
- economy: 표본 29편 · 노출 중앙값 1,315 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:semiconductor winner×1.51, event:interest_rate insufficient_data×1.16, macro_indicator insufficient_data×1.16, event:market_move insufficient_data×0.64, market_shock insufficient_data×0.64, event:ipo insufficient_data×0.61, company_event insufficient_data×0.44, household_money underperformer×0.27
- issue: 표본 36편 · 노출 중앙값 1,660 · 공유율 0.15% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.67, market_shock insufficient_data×0.9
- 정시 비교에서 제외한 늦은 백필: 72편

## 7d
- economy: 표본 31편 · 노출 중앙값 1,445 · 공유율 0.17% · 저장률 0.08%
...
- 편집 후보 실패: editorial_generation_failed 72건, unknown 44건
- 제목 재정제 실패: 2건
