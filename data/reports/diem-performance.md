...
- 상태: ready
- 발행 원장 Reel: 183편
- 생성 시각: 2026-09-03T19:08:58.754Z
...
- issue: 표본 46편 · 노출 중앙값 1,440 · 공유율 0% · 저장률 0%
  - 반복 후보: 주진우 증언 / 우원식표결지연(23,904), 선관위 / 서울시장 소청 기각(7,617), 북 미사일 발사 / 김여정 조롱(5,362), 한동훈 흉기 / 징역 1년 확정(3,867), 트럼프 분노 / 한국 희생양(3,691)
  - 부진 후보: 3인 가족 / 수수료 급등(157), 광복연휴 비예보 / 폭염 예상(173), 장동혁 발언 / 당원 주권 확대(178), 청주 초교생 / 교사 폭행 조사(179), 요코하마시장 사퇴 / 폭언 논란(180)
  - 특성 신호: market_shock insufficient_data×1.03, event:political_statement insufficient_data×0.64, reader_need:public_interest underperformer×0.18, household_money insufficient_data×0.15, reader_need:housing insufficient_data×0.15, work_life insufficient_data×0.12, reader_need:work insufficient_data×0.11
...
## 7d
- economy: 표본 51편 · 노출 중앙값 805 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: event:interest_rate insufficient_data×2.36, macro_indicator insufficient_data×2.36, reader_need:public_interest insufficient_data×2.02, work_life winner×1.79, housing_money winner×1.68, public_decision winner×1.68, event:semiconductor winner×1.45, event:market_move insufficient_data×1.1
