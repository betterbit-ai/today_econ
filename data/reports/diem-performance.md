...
- 상태: ready
- 발행 원장 Reel: 174편
- 생성 시각: 2026-08-31T10:36:34.060Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 42편 · 노출 중앙값 340 · 공유율 0% · 저장률 0%
...
- issue: 표본 42편 · 노출 중앙값 1,491 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.81, market_shock insufficient_data×0.99, event:political_statement insufficient_data×0.62, reader_need:public_interest underperformer×0.16, work_life insufficient_data×0.11, reader_need:work insufficient_data×0.1
...
## 7d
- economy: 표본 45편 · 노출 중앙값 1,324 · 공유율 0% · 저장률 0%
  - 반복 후보: 이재명 / ISA 개편 중단(730,307), 비거주1주택 / 징벌과세 결정(161,647), 이재명 대통령 / 휴가 권고(126,102), 공무원 / 광고 사과(4,696), 청년 퇴사 / 실업급여 추진(3,285)
  - 부진 후보: ETF·ETN / 핵심 차이(137), 서울 아파트값 / 16억 돌파(152), 주차 로봇 / 아파트 도입(165), 통영 폭우 / 도로·공장 붕괴(165), 에드가 휘경 / 1080억 공매(171)
  - 특성 신호: event:semiconductor winner×1.51, event:interest_rate insufficient_data×1.44, macro_indicator insufficient_data×1.44, event:market_move insufficient_data×0.67, market_shock insufficient_data×0.67, event:ipo insufficient_data×0.61, company_event insufficient_data×0.44, event:insurance_premium insufficient_data×0.14
...
## 이미지·음악 운영
- 타이포그래피 폴백률: 23.56%
- 생성 배경 폴백률: 14.94% · 전체 폴백률: 38.51%
- 이미지 공급원: pexels 96편, diem-original 41편, diem-generated 26편, unsplash 6편, wikimedia 4편, openverse 1편
