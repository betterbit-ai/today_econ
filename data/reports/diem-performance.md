...
- 상태: ready
- 발행 원장 Reel: 219편
- 생성 시각: 2026-09-14T16:13:24.653Z
- 원칙: 24h, 72h, 7d 지표를 섞지 않고 카테고리별 표본 5편 이상에서만 패턴을 학습합니다.

## 24h
- economy: 표본 61편 · 노출 중앙값 205 · 공유율 0% · 저장률 0%
  - 반복 후보: 비거주1주택 / 징벌과세 결정(91,127), 공무원 / 광고 사과(4,413), 백악관 경고 / 중국 환적 우려(2,226), 미국 관세 압박 / 한국 대응(2,018), 김민석 / 압승 확정(1,969)
  - 특성 신호: housing_money winner×2.52, event:ipo insufficient_data×2.29, market_shock insufficient_data×2.05, event:housing_policy winner×1.89, company_event winner×1.65, public_decision winner×1.47, event:semiconductor winner×1.46, event:insurance_premium insufficient_data×0.81
- issue: 표본 66편 · 노출 중앙값 911.5 · 공유율 0% · 저장률 0%
...
## 72h
- economy: 표본 61편 · 노출 중앙값 270 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: housing_money winner×1.99, market_shock insufficient_data×1.97, event:market_move insufficient_data×1.89, event:ipo insufficient_data×1.78, event:housing_policy winner×1.51, public_decision winner×1.37, reader_need:household_cost underperformer×0.67, event:insurance_premium insufficient_data×0.66
...
## 이미지·음악 운영
- 타이포그래피 폴백률: 19.18%
- 생성 배경 폴백률: 31.05% · 전체 폴백률: 50.23%
- 이미지 공급원: pexels 98편, diem-generated 68편, diem-original 42편, unsplash 6편, wikimedia 4편, openverse 1편
