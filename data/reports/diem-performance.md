...
- 상태: ready
- 발행 원장 Reel: 178편
- 생성 시각: 2026-09-02T08:27:26.336Z
...
## 72h
- economy: 표본 44편 · 노출 중앙값 437.5 · 공유율 0% · 저장률 0%
  ...
  - 특성 신호: reader_need:public_interest insufficient_data×3.71, event:interest_rate insufficient_data×3.5, event:semiconductor winner×2.65, event:market_move insufficient_data×1.91, market_shock insufficient_data×1.91, event:ipo insufficient_data×1.83, company_event insufficient_data×1.32, reader_need:credit insufficient_data×0.74
- issue: 표본 49편 · 노출 중앙값 1,562 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.77, market_shock insufficient_data×0.95, event:political_statement insufficient_data×0.59, reader_need:public_interest underperformer×0.16, work_life insufficient_data×0.11, reader_need:work insufficient_data×0.11
...
- issue: 표본 55편 · 노출 중앙값 1,630 · 공유율 0.09% · 저장률 0%
  - 반복 후보: 주진우 증언 / 우원식표결지연(38,433), 바이든 암 / 전이 확인(21,605), 국방부 / 1군단장 직무배제(18,351), 태풍 돌핀 / 한반도 영향예상(11,389), 선관위 / 서울시장 소청 기각(7,870)
  - 부진 후보: 광복연휴 비예보 / 폭염 예상(180), 장동혁 발언 / 당원 주권 확대(183), 백화점 난동 / 5년 형 선고(205), 전장연·시의회 / 타협 발표(239), 이주노동자 / 폭염 작업(314)
  - 특성 신호: market_shock insufficient_data×0.92, event:legislation underperformer×0.29, work_life insufficient_data×0.19, reader_need:public_interest insufficient_data×0.13
- 정시 비교에서 제외한 늦은 백필: 39편

## 이미지·음악 운영
- 타이포그래피 폴백률: 23.03%
- 생성 배경 폴백률: 16.85% · 전체 폴백률: 39.89%
- 이미지 공급원: pexels 96편, diem-original 41편, diem-generated 30편, unsplash 6편, wikimedia 4편, openverse 1편
