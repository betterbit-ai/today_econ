...
- issue: 표본 39편 · 노출 중앙값 1,545 · 공유율 0.09% · 저장률 0%
  ...
  - 특성 신호: event:housing_policy insufficient_data×1.75, market_shock insufficient_data×0.96, reader_need:public_interest underperformer×0.14, work_life insufficient_data×0.11, reader_need:work insufficient_data×0.1
...
## 7d
- economy: 표본 42편 · 노출 중앙값 1,345.5 · 공유율 0.07% · 저장률 0.04%
  ...
  - 특성 신호: event:semiconductor winner×1.48, event:interest_rate insufficient_data×1.41, macro_indicator insufficient_data×1.41, event:market_move insufficient_data×0.66, market_shock insufficient_data×0.66, event:ipo insufficient_data×0.6, company_event insufficient_data×0.43, event:insurance_premium insufficient_data×0.14
- issue: 표본 52편 · 노출 중앙값 1,647.5 · 공유율 0.11% · 저장률 0%
